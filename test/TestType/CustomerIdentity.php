...
final class CustomerIdentity implements Hashable
{
    public function __construct(public readonly string $tenant, public readonly string $customerNo)
    {
    }

    public function getHash(): string
    {
        return \hash('xxh3', $this->tenant . $this->customerNo);
    }
}
